...
delta_f0 = (2.82 - 2.8) / 14;
[Reflectance1] = ReCal(2.82);
[Reflectance2] = ReCal(2.82 - 1 * delta_f0);
[Reflectance3] = ReCal(2.82 - 2 * delta_f0);
[Reflectance4] = ReCal(2.82 - 3 * delta_f0);
[Reflectance5] = ReCal(2.82 - 4 * delta_f0);
[Reflectance6] = ReCal(2.82 - 5 * delta_f0);
[Reflectance7] = ReCal(2.82 - 6 * delta_f0);
[Reflectance8] = ReCal(2.82 - 7 * delta_f0);
[Reflectance9] = ReCal(2.82 - 8 * delta_f0);
[Reflectance10] = ReCal(2.82 - 9 * delta_f0);
[Reflectance11] = ReCal(2.82 - 10 * delta_f0);
[Reflectance12] = ReCal(2.82 - 11 * delta_f0);
[Reflectance13] = ReCal(2.82 - 12 * delta_f0);
[Reflectance14] = ReCal(2.82 - 13 * delta_f0);
[Reflectance15] = ReCal(2.82 - 14 * delta_f0);
