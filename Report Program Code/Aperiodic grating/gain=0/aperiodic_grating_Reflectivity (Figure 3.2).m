...
theta2_2 = (3*pi/2)*fn+1i*3*g;      %For 2*lamda     
theta2_3 = (3*pi)*fn+1i*6*g;        %For 3.5*lamda           
theta2_4 = (2*pi)*fn+1i*4*g;        %For 2.5*lamda 
...
M_mid = (Pn1*S12*Pn2_2*S21)*(Pn1*S12*Pn2_1*S21)*(Pn1*S12*Pn2_2*S21)*(Pn1*S12*Pn2_3*S21)*(Pn1*S12*Pn2_2*S21)*(Pn1*S12*Pn2_1*S21)*(Pn1*S12*Pn2_2*S21)*(Pn1*S12*Pn2_1*S21)*(Pn1*S12*Pn2_1*S21)*(Pn1*S12*Pn2_1*S21)*(Pn1*S12*Pn2_4*S21)*(Pn1*S12*Pn2_2*S21)*(Pn1*S12*Pn2_2*S21);
...
figure;
% plot(Normalized_frequency,Reflectance,'b','LineWidth',1);
% hold on;
